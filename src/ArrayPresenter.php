...
/**
 * ArrayPresenter is intended for converting the given array to an array with another structure.
 */
...
{   
    ...
    /**
     * Sets or returns the data to transform.
     *
     * @param array $data
     * @return mixed
     * @access public
     ...
     * @access protected
     */
    protected function convert($force = false)
    {
